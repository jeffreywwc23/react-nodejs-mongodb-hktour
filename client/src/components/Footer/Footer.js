...
export default React.memo(function Footer() {
    ...
    useEffect(() => {
        const elementSelfFadeIn = tl.from(footerTitle.current, {
            y: 30,
            duration: 0.5,
            opacity: 0,
            ease: Power3.easeOut,
    ...
    return (
        <footer>
            ...
            <div className="social-media-section" ref={socialMediaSection}>
                <h1 className="social-media-section-h1" ref={socialMediaSectionH1}>Follow us</h1>
                <p className="social-media-section-p" ref={socialMediaSectionP}>Share Your Travelogue With Us</p>
            </div>
            ...
            <p className="copyrights">&copy; By 2020 Jeffreywwc</p>
        </footer>
    )
});
