export const INITIAL_STATE = {
    servicesContent: [
        ...
        },
        {
            id: 2,
            title: 'immersive',
            imageUrl: 'https://content.api.news/v3/images/bin/8e22861ab7d4ddb83e10590b9ea5d3b6?width=1280',
            text: 'Truly experience each destination rather than view it'
        },
        {
            id: 3,
            title: 'quality',
            imageUrl: 'https://cdn.shortpixel.ai/spai/w_1201+q_lossy+ret_img+to_webp/https://toomanyadapters.com/wp-content/uploads/2019/01/Laptop-map-camera.jpg',
